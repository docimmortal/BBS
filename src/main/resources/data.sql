...
INSERT INTO User_Details (username, first_name, last_name, email, photo) values 
...
INSERT INTO Messages(title, message, user_details_id, message_forum_id) values ('Hello!',CAST('This is a test message.' AS CLOB),1,1);
INSERT INTO Messages(title, message, user_details_id, message_forum_id) values ('Test 2',CAST('This is another test message.' AS CLOB),2,1);
INSERT INTO Messages(title, message, user_details_id, message_forum_id) values ('Ha ha!',CAST('This is another new message.' AS CLOB),1,2);
